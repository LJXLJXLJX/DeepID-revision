...
def compare(pic1,pic2):
    ...
    #pic1=cv2.resize(pic1,(47,55)).reshape(1,55,47,3)

    #pic2=cv2.imread(pic2)
    #pic2=cv2.resize(pic2,(47,55)).reshape(1,55,47,3)

    pic1=faceDetect(pic1).reshape(1,55,47,3)
    pic2=faceDetect(pic2).reshape(1,55,47,3)
...
pic1='224pics_nolens/90A1.jpg'
pic2='224pics_nolens/95A1.jpg'
start=time.time()
sim=compare(pic1,pic2)
print(sim,' ',time.time()-start,'s')